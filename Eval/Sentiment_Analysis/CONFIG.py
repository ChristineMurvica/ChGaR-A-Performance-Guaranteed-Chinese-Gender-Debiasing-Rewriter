class CONFIG2():
    ...
    vocab_size = 170559         # 词汇量，与word2id中的词汇量一致
    ...
    save_dir = './t_checkpoints/' # 训练模型保存的地址
    train_path = './data/t_train.txt'
    dev_path = './data/t_val.txt'
    test_path = './data/t_test.txt'
    all_path = './data/t_total.txt'
    word2id_path = './data/t_word_to_id.txt'
    pre_word2vec_path = './data/cbow_after_word2vec.bin'
    corpus_word2vec_path = './data/t_corpus_word2vec.txt'
...
class CONFIG1():
    ...
    all_path = './data/total.txt'
    word2id_path = './data/word_to_id.txt'
    pre_word2vec_path = './data/cbow_s_word2vec.bin'
